...
try:
    ...
    for row in df.itertuples():
        print(row.PSI, row.Volume_inlakhs_FY_202122, row.Volume_inlakhs_2021_July, row.Volume_inlakhs_2022_June, row.Volume_inlakhs_2022_July, row.Value_inCrore_FY_202122, row.Value_inCrore_2021_July, row.Value_inCrore_2022_June, row.Value_inCrore_2022_July)
        cur.execute(" INSERT INTO RBI (Payment_System_Indicators, Volume_inlakhs_FY_202122, Volume_inlakhs_2021_July, Volume_inlakhs_2022_June, Volume_inlakhs_2022_July, Value_inCrore_FY_202122, Value_inCrore_2021_July, Value_inCrore_2022_June, Value_inCrore_2022_July) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s);",
